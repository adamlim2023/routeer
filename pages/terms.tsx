  ...
  return (
    <MainLayout>
      ...
      <div className="max-w-[1440px] mx-auto pt-[65px] px-4 tablet:px-16 relative">
        <div className="pt-14 tablet:pt-[100px] pb-14 tablet:pb-28 desktop:pb-20">
          <p className="w-full desktop:w-3/5 text-[40px] tablet:text-[64px] leading-none font-bold text-hotpink mb-[30px] tracking-[-1px]">
            Terms and Conditions / User Agreement
          </p>
          <p className="text-xl text-gray font-bold mb-[60px] uppercase">
            Last Updated 25th January 2021
          </p>

          <div className="text-base text-darkgray">
            <span className="text-2xl font-bold text-cyanblue tracking-[-1px]">
              1. Agreement to Terms
            </span>
            <br />
            <br /> 1.1  These Terms and Conditions constitute a legally binding
            agreement made between you, whether personally or on behalf of an
            entity (<span className="text-black font-bold">you</span>), and 
            <span className="text-black font-bold">Routeer Limited</span>
            , located at 
            <span className="text-black font-bold">
              50 Geoffrey House, Pardoner Street, London, SE1 4DW United Kingdom
            </span>
             (<span className="text-black font-bold">we, us</span>), concerning
            your access to and use of the 
            <span className="text-black font-bold">Routeer.com</span>
             (
            <span className="text-hotpink font-bold">https://routeer.com</span>
            ) website as well as any related applications (
            <span className="text-black font-bold">the Site</span>).  
            <br />
            <br />
            The Site provides the following services: 
            <span className="font-bold">
              online platform for connecting users (travellers) with transport
            ...
            may not be used in connection with any commercial endeavours except
            ...
            or creating user accounts under false pretences  
            <br />
            ...
            <br />
            • Use the Site to advertise or sell goods and services not related
            to transport 
            <br />
            ...
            password you must promptly notify us at hello@routeer.com. <br />
            <br />
            ...
            registered to use the Site. At your email request
            to hello@routeer.com or through your account settings (if
            ...
            <span className="font-bold">User Content</span>). You understand and
            agree that your User Content may be viewed by other users on the
            ...
            users please contact us at hello@routeer.com or use the take down or
            report button.
            <br />
            <br />
            <span className="text-2xl font-bold text-cyanblue tracking-[-1px]">
            ...
            <span className="font-bold">Our Content</span>) are owned or
            ...
            greater of (a) the sum of £5000 or (b) the amount paid, if any, by
            you to us for the Services/Site during the six (6) month period
            prior to any cause of action arising.   
            <br />
            <br />
            <span className="font-bold">If you are a business user: </span>
            <br />
            <br />
            ...
            <br />
            <br /> In particular, we will not be liable for: 
            <br />
            <br />
            ...
            by contacting us at hello@routeer.com.   <br />
            <br />
            ...
            Conditions or of any applicable law or regulation.   <br />
            <br />
            ...
            warning, in our sole discretion.   <br />
            <br />
            ...
            <br />
            <br />
            11.2  <span className="font-bold">For business users only</span> -
            You will not:   
            <br />
            <br />
            ...
            <br />
            <br />
            (e) use the application for any revenue generating endeavour,
            ...
            <br />
            <br />
            12.8  <span className="font-bold">For business users only</span> -
            ...
            <br />
            <br />
            12.9  The following are trade marks of Routeer Limited. You are not
            ...
            <br />
            •  UK00003183777, trade marked in UK
            <br />
            12.10  Except as stated under the Mobile Application section,
            ...
            <br />
            <br />
            12.11  In order to resolve a complaint regarding the Services or to
            receive further information regarding use of the Services, please
            contact us by email at hello@routeer.com or by post to:
            <br />
            <br />
            Routeer Limited 
            <br />
            50 Geoffrey House, Pardoner Street 
            <br />
            London, SE1 4DW   
            <br />
            United Kingdom
